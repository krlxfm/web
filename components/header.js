...
<div className="text-2xl text-center">KRLX.ORG</div>
      ...
      <div className="col-span-4 md:col-span-3">
        ...
        <audio src="https://stream.krlx.org:8000/_a" controls/>
        Click above to play the radio. If the player is not working <Link as={`https://stream.krlx.org:8000/_a `} href="https://stream.krlx.org:8000/_a ">
          <a
